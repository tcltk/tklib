...
# demo_editrect.tcl --
#
# This demonstration script creates a canvas widget where you can edit a rectangle
...
toplevel       $w
wm title       $w "Canvas :: Editor :: Rectangle"
wm iconname    $w "CEP"
set c          $w.c
...
canvas::edit rectangle EDITOR $c -data-cmd M
