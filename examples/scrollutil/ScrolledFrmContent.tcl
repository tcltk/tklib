...
$sa setwidget $txt
grid $sa -row $row -column 0 -columnspan 3 -sticky w -padx 9p -pady {3p 0}
...
$sa setwidget $lb
grid $sa -row $row -rowspan 6 -column 0 -sticky w -padx {9p 0} -pady {3p 0}
...
$sa setwidget $tv
grid $sa -row $row -column 0 -columnspan 3 -sticky w -padx 9p -pady {3p 9p}
...
pack $sf -expand yes -fill both -padx 9p -pady 9p
