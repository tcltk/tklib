...
$sa setwidget $txt
grid $sa -row $row -column 0 -columnspan 3 -sticky w -padx 7p -pady {4p 0}
...
$sa setwidget $lb
grid $sa -row $row -rowspan 6 -column 0 -sticky w -padx {7p 0} -pady {4p 0}
...
$sa setwidget $tv
grid $sa -row $row -column 0 -columnspan 3 -sticky w -padx 7p -pady {4p 7p}
...
proc configTablelist {} {
    ...
    set height [expr {10*$rowHeight + [winfo pixels .top 4p] + 2}]
    $sf configure -width $width -height $height
