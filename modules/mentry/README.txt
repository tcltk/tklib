...
distribution file is "mentry3.8.tar.gz" for UNIX and "mentry3_8.zip"
...
distribution file "mentry3.8.tar.gz":

    gunzip -c mentry3.8.tar.gz | tar -xf -

This command will create a directory named "mentry3.8", with the
subdirectories "demos", "doc", and "scripts".

On Windows, use WinZip or some other program capable of unpacking the
distribution file "mentry3_8.zip" into the directory "mentry3.8", with
