...
distribution file is "mentry3.17.tar.gz" for UNIX and "mentry3_17.zip"
...
distribution file "mentry3.17.tar.gz":
...
Both commands will create a directory named "mentry3.17", with the
subdirectories "demos", "doc", and "scripts".

On Windows, use WinZip or some other program capable of unpacking the
distribution file "mentry3_17.zip" into the directory "mentry3.17", with
