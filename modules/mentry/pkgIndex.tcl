...
# Regular packages:
#
package ifneeded mentry         4.1 \
	[list source [file join $dir mentry.tcl]]
package ifneeded mentry_tile    4.1 \
...
#
package ifneeded Mentry         4.1 \
	[list package require -exact mentry      4.1]
package ifneeded Mentry_tile    4.1 \
	[list package require -exact mentry_tile 4.1]

#
# Code common to all packages:
#
package ifneeded mentry::common 4.1 \
