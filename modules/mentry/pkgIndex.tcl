...
# Regular packages:
#
package ifneeded mentry         3.8 \
	[list source [file join $dir mentry.tcl]]
package ifneeded mentry_tile    3.8 \
...
#
package ifneeded Mentry         3.8 \
	[list package require -exact mentry      3.8]
package ifneeded Mentry_tile    3.8 \
	[list package require -exact mentry_tile 3.8]

#
# Code common to all packages:
#
package ifneeded mentry::common 3.8 \
