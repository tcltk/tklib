...
snit::type ::map::box::map-display {
	...
	set gbox   [dict get $myboxes $id geobox]
	...
	if {[dict exists $myboxes $id geobox]} return
	dict set myboxes $id geobox [dict get [DO get $id] geobox]
	return
    }
