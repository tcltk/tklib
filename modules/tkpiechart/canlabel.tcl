set rcsId {$Id: canlabel.tcl,v 1.18 1998/03/14 09:48:05 jfontain Exp $}
...
proc canvasLabel::configure {this args} {                                                           ;# emulate label widget behavior
    set update 0
    ...
    foreach option [array names value] {
        switch -- $option {
            ...
            -padding {
                set canvasLabel::($this,padding) [winfo fpixels $canvasLabel::($this,canvas) $value($option)]   ;# convert to pixels
                set update 1
            }
            -bulletwidth {
...
proc canvasLabel::update {this} {
    ...
    set anchor $canvasLabel::($this,anchor)                                       ;# now move rectangle and text according to anchor
