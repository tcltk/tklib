#==============================================================================
# Contains Wcb procedures for Tk or Ttk entry, BWidget Entry, Tk or Ttk
# spinbox, and Ttk combobox widgets.
#
# REMARK: Everything stated below for entry widgets is valid for Ttk entry and
#         BWidget Entry widgets, too.  Similarly, everything stated below for
#         spinbox widgets is valid for Ttk spinbox widgets, too.
#
...
#
# Utility procedures for entry, spinbox, and Ttk combobox widgets
# ===============================================================
#
...
# wcb::changeEntryText
#
# Replaces the text of the entry, spinbox, or Ttk combobox widget w with the
...
# original entry, spinbox, or Ttk combobox string and returns 0, otherwise it
# returns 1.
#------------------------------------------------------------------------------
...
# or Ttk combobox widget w after inserting the string str.
#------------------------------------------------------------------------------
...
#
# Returns the text that would be contained in the entry, spinbox, or Ttk
...
# entry, spinbox, and Ttk combobox widgets
# ==========================================
#
...
#
# Checks whether the string str to be inserted into the entry, spinbox, or Ttk
...
# wcb::convStrToUpper
#
# Replaces the string str to be inserted into the entry, spinbox, or Ttk
...
#
# Checks whether the text contained in the entry, spinbox, or Ttk combobox
...
# Ttk combobox widget w after inserting the string str would be greater than
...
# wcb::entryWidgetCmd
#
# Processes the Tcl command corresponding to an entry, spinbox, or Ttk combobox
# widget w with registered callbacks.  In this procedure, the execution of the
# commands insert, delete, and icursor is preceded by calls to the
