...
The distribution file is "wcb4.0.tar.gz" for UNIX and "wcb4_0.zip" for
...
distribution file "wcb4.0.tar.gz":

    gunzip -c wcb4.0.tar.gz | tar -xf -

On most UNIX systems this can be replaced with

    tar -zxf wcb4.0.tar.gz

Both commands will create a directory named "wcb4.0", with the
subdirectories "demos", "doc", and "scripts".

On Windows, use WinZip or some other program capable of unpacking the
distribution file "wcb4_0.zip" into the directory "wcb4.0", with the
subdirectories "demos", "doc", and "scripts".
