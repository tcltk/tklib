...
distribution file "wcb3.7.tar.gz":

    gunzip -c wcb3.7.tar.gz | tar -xf -

On most UNIX systems this can be replaced with

    tar -zxf wcb3.7.tar.gz

Both commands will create a directory named "wcb3.7", with the
subdirectories "demos", "doc", and "scripts".

On Windows, use WinZip or some other program capable of unpacking the
distribution file "wcb3_7.zip" into the directory "wcb3.7", with the
subdirectories "demos", "doc", and "scripts".
