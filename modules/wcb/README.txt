...
The distribution file is "wcb3.8.tar.gz" for UNIX and "wcb3_8.zip" for
...
distribution file "wcb3.8.tar.gz":

    gunzip -c wcb3.8.tar.gz | tar -xf -

On most UNIX systems this can be replaced with

    tar -zxf wcb3.8.tar.gz

Both commands will create a directory named "wcb3.8", with the
subdirectories "demos", "doc", and "scripts".

On Windows, use WinZip or some other program capable of unpacking the
distribution file "wcb3_8.zip" into the directory "wcb3.8", with the
subdirectories "demos", "doc", and "scripts".
