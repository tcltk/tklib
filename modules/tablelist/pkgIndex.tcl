...
# Regular packages:
#
package ifneeded tablelist         4.6 \
	[list source [file join $dir tablelist.tcl]]
package ifneeded tablelist_tile    4.6 \
	[list source [file join $dir tablelist_tile.tcl]]

#
# Aliases:
#
package ifneeded Tablelist         4.6 { package require tablelist }
package ifneeded Tablelist_tile    4.6 { package require tablelist_tile }

#
# Code common to all packages:
#
package ifneeded tablelist::common 4.6 \
