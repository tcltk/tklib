...
package ifneeded tablelist_tile    4.12.1 \
...
#
package ifneeded Tablelist         4.12.1 \
	[list package require -exact tablelist	    4.12.1]
package ifneeded Tablelist_tile    4.12.1 \
	[list package require -exact tablelist_tile 4.12.1]

#
# Code common to all packages:
#
package ifneeded tablelist::common 4.12.1 \
