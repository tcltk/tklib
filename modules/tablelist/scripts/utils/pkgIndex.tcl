...
package ifneeded scaleutil  1.11 [list source [file join $dir scaleutil.tcl]]
package ifneeded scaleutilmisc 1.4 \
	[list source [file join $dir scaleutilMisc.tcl]]
package ifneeded themepatch 1.4  [list source [file join $dir themepatch.tcl]]
