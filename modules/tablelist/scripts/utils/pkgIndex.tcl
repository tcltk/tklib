...
package ifneeded scaleutil  1.10 [list source [file join $dir scaleutil.tcl]]
package ifneeded scaleutilmisc 1.3 \
	[list source [file join $dir scaleutilMisc.tcl]]
package ifneeded themepatch 1.3  [list source [file join $dir themepatch.tcl]]
