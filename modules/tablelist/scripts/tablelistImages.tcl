...
proc tablelist::photo7x4Arrows w {
    image create photo triangleUpImg$w -data "
...
AB8ALAAAAAAHAAQAAAUS4CcSYikcRRkYypJ8A9IwD+SEADs="
    ...
    image create photo triangleDnImg$w -data "
...
yHedy79GwWjF0GxNEF8RV8xcn9feTd3hROPkWSLn4lDqtCrv8PHy8/T19vYhADs="
	...
	variable checkedImg \
	    [image create photo tablelist_checkedImg   -data $checkedData]
	variable uncheckedImg \
	    [image create photo tablelist_uncheckedImg -data $uncheckedData]
	variable tristateImg \
	    [image create photo tablelist_tristateImg  -data $tristateData]
    }
}
...
GIpkqZ1opa5bK15wPNNnPJJ4zu385PsBgj8iz4g8FAAAOw=="

	tablelist_bicolor175_expandedSelImg put "
R0lGODlhHAAVAIAAAP///////yH5BAEKAAEALAAAAAAcABUAAAIrjI+py+0Po5w0gYuzzm373X0i
4IweZHJRSk5mFYiwcc60at9tzvf+D4wUAAA7"
    }
}
...
oE4JhrzIRwmG/mlDgkvC4kWCSxOrkiCSJHGiAIrBqhVW+u3AAAAAAElFTkSuQmCC"
    } else {
	tablelist_bicolor200_collapsedSelImg put "
R0lGODlhIAAYAIAAAP///////yH5BAEKAAEALAAAAAAgABgAAAI9jI+pywbfYnxQWkTrtVnv1nmf
EorjUZpnqn5se72wJAMnKt/Oq+9p7wsBg5khcebqGHGUJdPm9EVx02qgAAA7"

	tablelist_bicolor200_expandedSelImg put "
R0lGODlhIAAYAIAAAP///////yH5BAEKAAEALAAAAAAgABgAAAIyjI+py+0Po5y02nuA3rx74Hzi
94wmCJ2kpHJVi74nFpi0Id5ZpyNu74sBh8Si8YiEFAAAOw=="
    }
}
...
3i4zSClNMcbl6s7VJ2455+nIP+pMNNaHyJkHAAAAAElFTkSuQmCC"
    } else {
	tablelist_classic100_collapsedImg put "
...
eLrcKyHKIJwgJesyKgtbGDRgqI2feZIZ4LoZupSqrNCmfeBiIwyqjmUi8SwSADs="
    }
}
...
0Ukp9WzTPwABuUrqqk2YUQAAAABJRU5ErkJggg=="
    } else {
	tablelist_classic125_collapsedImg put "
...
l6g+OeceiOiWmd/met4BZJFMcWEB1qgAAAAASUVORK5CYII="
    } else {
	tablelist_classic150_collapsedImg put "
...
BzcnBQYJDJqbnAcyMBArNTUFAichADs="
...
j5Flk4qVIwUDEo9JCkUoAwkWjxUGdSMzCA0Orq+wDguooSgEN7i3tSUhADs="
    }
}
...
acjp8gu1rtuiKF5UdS0iGXA1dikFPPCQspS+Azr+W1W366nTAAAAAElFTkSuQmCC"
...
Tl1KAQ/c5yylJw9fVU2JFCmBAAAAAElFTkSuQmCC"
    } else {
	tablelist_classic200_collapsedImg put "
...
HDVAaDgHhIffMpV+5Qur9wxrL3tFbQAAAABJRU5ErkJggg=="
...
yV0yRBMAAAAASUVORK5CYII="
    } else {
	tablelist_${treeStyle}_collapsedImg put "
R0lGODlhGAASAKECAH9/f4CAgP///////yH5BAEKAAIALAAAAAAYABIAAAItlI+pCxELVXOxikkt
c1xL3nkHBooGWYpo6K1ZC6Zw/JirecZ4zuLYPnoBh4ICADs="
...
U7Fv+duf5gUUuBnxse4v2gAAAABJRU5ErkJggg=="
