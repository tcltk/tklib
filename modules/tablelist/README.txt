...
distribution file is "tablelist6.15.tar.gz" for UNIX and
"tablelist6_15.zip" for Windows.  These files contain the same
...
distribution file "tablelist6_15.zip" into the directory
