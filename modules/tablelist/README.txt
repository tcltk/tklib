...
the distribution file "tablelist4.2.tar.gz":

    gunzip -c tablelist4.2.tar.gz | tar -xf -

This command will create a directory named "tablelist4.2", with the
subdirectories "demos", "doc", "images", and "scripts".

On Windows, use WinZip or some other program capable of unpacking the
distribution file "tablelist4_2.zip" into the directory "tablelist4.2",
