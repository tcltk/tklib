...
distribution file is "tablelist4.7.tar.gz" for UNIX and
"tablelist4_7.zip" for Windows.  These files contain the same
...
the distribution file "tablelist4.7.tar.gz":

    gunzip -c tablelist4.7.tar.gz | tar -xf -

This command will create a directory named "tablelist4.7", with the
subdirectories "demos", "doc", and "scripts".

On Windows, use WinZip or some other program capable of unpacking the
distribution file "tablelist4_7.zip" into the directory "tablelist4.7",
