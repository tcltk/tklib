...
distribution file is "tablelist6.12.tar.gz" for UNIX and
"tablelist6_12.zip" for Windows.  These files contain the same
...
the distribution file "tablelist6.12.tar.gz":

    gunzip -c tablelist6.12.tar.gz | tar -xf -

On most UNIX systems this can be replaced with

    tar -zxf tablelist6.12.tar.gz

Both commands will create a directory named "tablelist6.12 with the
subdirectories "demos", "doc", and "scripts".

On Windows, use WinZip or some other program capable of unpacking the
distribution file "tablelist6_12.zip" into the directory
"tablelist6.12", with the subdirectories "demos", "doc", and "scripts".
