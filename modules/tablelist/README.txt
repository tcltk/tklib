...
distribution file is "tablelist7.12.tar.gz" for UNIX and
"tablelist7_12.zip" for Windows.  These files contain the same
...
the distribution file "tablelist7.12.tar.gz":
...
Both commands will create a directory named "tablelist7.12 with the
subdirectories "demos", "doc", and "scripts".

On Windows, use WinZip or some other program capable of unpacking the
distribution file "tablelist7_12.zip" into the directory
"tablelist7.12", with the subdirectories "demos", "doc", and "scripts".
