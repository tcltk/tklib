...
distribution file is "tablelist7.11.tar.gz" for UNIX and
"tablelist7_11.zip" for Windows.  These files contain the same
...
the distribution file "tablelist7.11.tar.gz":

    gunzip -c tablelist7.11.tar.gz | tar -xf -

On most UNIX systems this can be replaced with

    tar -zxf tablelist7.11.tar.gz

Both commands will create a directory named "tablelist7.11 with the
subdirectories "demos", "doc", and "scripts".

On Windows, use WinZip or some other program capable of unpacking the
distribution file "tablelist7_11.zip" into the directory
"tablelist7.11", with the subdirectories "demos", "doc", and "scripts".
