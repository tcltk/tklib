...
# Regular packages:
#
package ifneeded scrollutil         2.1 \
	[list source [file join $dir scrollutil.tcl]]
package ifneeded scrollutil_tile    2.1 \
...
#
package ifneeded Scrollutil         2.1 \
	[list package require -exact scrollutil      2.1]
package ifneeded Scrollutil_tile    2.1 \
	[list package require -exact scrollutil_tile 2.1]

#
# Code common to all packages:
#
package ifneeded scrollutil::common 2.1 \
