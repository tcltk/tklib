...
# Regular packages:
#
package ifneeded scrollutil         1.9 \
	[list source [file join $dir scrollutil.tcl]]
package ifneeded scrollutil_tile    1.9 \
...
#
package ifneeded Scrollutil         1.9 \
	[list package require -exact scrollutil      1.9]
package ifneeded Scrollutil_tile    1.9 \
	[list package require -exact scrollutil_tile 1.9]

#
# Code common to all packages:
#
package ifneeded scrollutil::common 1.9 \
