#==============================================================================
# mwutil, scaleutil, themepatch, and wsb package index file.
#
...
package ifneeded themepatch 1.9  [list source [file join $dir themepatch.tcl]]
package ifneeded wsb	    1.0  [list source [file join $dir wsb.tcl]]
