...
The distribution file is "scrollutil2.7.tar.gz" for UNIX and
"scrollutil2_7.zip" for Windows.  These files contain the same
...
the distribution file "scrollutil2.7.tar.gz":

    gunzip -c scrollutil2.7.tar.gz | tar -xf -

On most UNIX systems this can be replaced with

    tar -zxf scrollutil2.7.tar.gz

Both commands will create a directory named "scrollutil2.7", with the
subdirectories "demos", "doc", and "scripts".

On Windows, use WinZip or some other program capable of unpacking the
distribution file "scrollutil2_7.zip" into the directory
"scrollutil2.7", with the subdirectories "demos", "doc", and "scripts".
