...
The distribution file is "scrollutil1.12.tar.gz" for UNIX and
"scrollutil1_12.zip" for Windows.  These files contain the same
...
the distribution file "scrollutil1.12.tar.gz":
...
Both commands will create a directory named "scrollutil1.12", with the
subdirectories "demos", "doc", and "scripts".

On Windows, use WinZip or some other program capable of unpacking the
distribution file "scrollutil1_12.zip" into the directory
"scrollutil1.12", with the subdirectories "demos", "doc", and "scripts".
